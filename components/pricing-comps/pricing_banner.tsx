    ...
    <section className="relative h-auto overflow-hidden bg-[#3365E30A] pb-24 pt-28 xl:flex xl:h-[70vh] xl:items-center xl:pt-36">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto flex max-w-[375px] flex-col items-center text-center sm:max-w-md md:max-w-xl lg:max-w-4xl xl:justify-start">
          ...
          <h1 className="z-10 mb-4 mt-6 w-full text-[2rem] font-bold text-[#101828] sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
            <span className="text-main-100">Flexible Plans</span> for Every Data
            Need
          </h1>
          <p className="text-center leading-normal text-[#434343] md:mx-auto md:max-w-lg">
            Discover cost-effective pricing tailored to empower your data
            collection and analysis goals, no matter your scale or industry.
          </p>
        </div>
      </div>
    </section>
