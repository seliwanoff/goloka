...
import { getTrxId, getTrxOrgId } from "@/services/transactions";
import { useQuery } from "@tanstack/react-query";

const InvoiceModalOrganization = () => {
  ...
  const {
    ...
    queryFn: async () => (id ? await getTrxOrgId(id) : null),
    enabled: !!id,
  });
...
export default InvoiceModalOrganization;
