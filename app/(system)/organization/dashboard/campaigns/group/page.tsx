          ...
          <div className="flex w-full flex-col gap-12">
            <Label htmlFor="questionType" className="w-full">
              <div className="flex items-center justify-between">
                ...
                <Link href="/">
                  <span className="mb-2 inline-flex cursor-pointer items-center gap-1 font-poppins text-base font-extralight text-[#3365E3]">
                    ...
                    <SelectGroup>
                      ...
                      {stateData?.map((item) => (
                        <SelectItem
                          ...
                          className={`flex items-center gap-2 ${
                            selectedStates.includes(item.id) ? "font-bold" : ""
                          }`}
                        >
                          {item.label}
                        </SelectItem>
